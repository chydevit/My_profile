...
const Icons = {
    ...
    NodeJS: (props: any) => (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path fill="currentColor" d="M12 0L2.4 5.5v11L12 22l9.6-5.5v-11L12 0zm0 2.5l7 4v8l-7 4-7-4v-8l7-4z" />
        </svg>
    ),
    Figma: (props: any) => (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path fill="currentColor" d="M12 12c-1.657 0-3-1.343-3-3s1.343-3 3-3 3 1.343 3 3-1.343 3-3 3zm0-6c-1.657 0-3-1.343-3-3s1.343-3 3-3 3 1.343 3 3-1.343 3-3-3-3 1.343-3 3zM6 12c0 1.657 1.343 3 3 3s3-1.343 3-3-1.343-3-3-3-3 1.343-3 3zM6 6c0 1.657 1.343 3 3 3s3-1.343 3-3-1.343-3-3-3-3 1.343-3 3zM6 18c0 1.657 1.343 3 3 3s3-1.343 3-3-1.343-3-3-3V18z" />
        </svg>
    ),
    MongoDB: (props: any) => (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path fill="currentColor" d="M17.193 9.555c-1.137-3.725-3.23-5.69-5.12-8.555L12 11.652 11.927 1c-1.89 2.87-3.985 4.834-5.122 8.554C6.208 11.53 6 13.427 6 15.36 6 19.86 9.873 23 12 23s6-3.14 6-7.64c0-1.933-.208-3.83-.807-5.805z" />
        </svg>
    )
};
