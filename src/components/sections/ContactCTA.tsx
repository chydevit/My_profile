        ...
        <section className="holo-section relative overflow-hidden py-20 bg-[linear-gradient(135deg,rgba(6,182,212,0.18),rgba(15,23,42,0.94)_38%,rgba(30,41,59,0.94))]">
            ...
            <Container className="relative z-10">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="relative mx-auto max-w-3xl overflow-hidden rounded-[2rem] border border-white/12 bg-[linear-gradient(145deg,rgba(7,20,39,0.78),rgba(15,23,42,0.58))] px-5 py-10 text-center shadow-[0_24px_80px_rgba(2,6,23,0.4)] backdrop-blur-xl sm:px-8 sm:py-12"
                >
                    <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.12),transparent_24%)]" />
                    ...
                    <motion.div
                        ...
                        className="relative mb-6 inline-flex rounded-full border border-cyan-300/30 bg-cyan-300/12 p-4 backdrop-blur-sm shadow-[0_0_40px_rgba(34,211,238,0.18)]"
                    >
                        <Mail className="w-12 h-12 text-cyan-100" />
                    </motion.div>

                    {/* Heading */}
                    <h2 className="relative mb-4 text-3xl font-heading font-bold text-white sm:text-4xl md:text-5xl">
                        {t('letsWorkTogether')}
                    </h2>

                    {/* Description */}
                    <p className="relative mx-auto mb-8 max-w-2xl text-base text-slate-200/90 sm:text-lg">
                        {t('contactDescription')}
                    </p>

                    {/* CTA Buttons */}
                    <div className="relative flex flex-col justify-center gap-3 sm:flex-row sm:flex-wrap sm:gap-4">
                        <Link
                            href="/contact"
